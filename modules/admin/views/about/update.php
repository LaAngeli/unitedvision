...
$this->title = 'Actualizare slide: ' . Html::encode($model->name);
    ...
    <div class="grid-wrapper">
        <?= BreadcrumbsWidget::widget([
            ...
            [
                ...
                [
                    'label' => "Informații slide:  " . Html::encode($model->name),
                    'url' => ['/admin/about/view', 'id' => $model->id, 'name' => $urlCreator->createUrl($model->name)]
                ],
                [
                    'label' => $this->title,
                ],
