...
$this->title = 'Actualizare utilizator: ' . Html::encode($model->email);
    ...
    <div class="grid-wrapper">
        <?= BreadcrumbsWidget::widget([
            ...
            [
                ...
                [
                    'label' => "Informații:  " . Html::encode($model->email),
                    'url' => ['/admin/user/view', 'id' => $model->id, 'email' => $urlCreator->createUrl($model->email)]
                ],
                [
                    'label' => $this->title,
                ],
    ...
    <div class="form-wrapper d-flex flex-column">
        ...
        <?= ActionsButtonsWidget::widget([
            ...
            [
                ...
                [
                    'label' => 'Detalii',
                    'action' => ['view', 'id' => $model->id, 'email' => $urlCreator->createUrl($model->email)],
