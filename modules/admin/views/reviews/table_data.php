    ...
    [
        ...
        [
            ...
            'action' => function ($data) {
                ...
                return ['view', 'id' => $data->id, 'name' => $urlCreator->createUrl($data->initials)];
            },
            'options' => [null]
        ],
        ...
        [
            ...
            'action' => function ($data) {
                $urlCreator = new UrlCreator;
                return ['update', 'id' => $data->id, 'name' => $urlCreator->createUrl($data->initials)];
            },
            'options' => [null]
        ],
        ...
        [
            ...
            'action' => function ($data) {
                $urlCreator = new UrlCreator;
                return ['delete-row', 'id' => $data->id, 'name' => $urlCreator->createUrl($data->initials)];
            },
            'options' =>  function ($data) {
                return ['class' => 'delete-record-modal', 'confirm' => 'Ești sigur că vrei să ștergi această înregistrare: ' . $data->initials];
            }
        ],
